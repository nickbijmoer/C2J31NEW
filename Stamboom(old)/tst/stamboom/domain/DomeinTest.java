...
public class DomeinTest extends TestCase{
    ...
    public void testAddPersoon() {
         ...
         */
        assertEquals("persoonsnummering onjuist", 2, piet.getNr());
        assertEquals("persoonsnummering onjuist", 4, jan.getNr());
        ...
        assertEquals("zoeken op achternaam onjuist", 3, swinkelsen.size());
    ...
    public void testGetPersonenMetAchternaam() {
        ...
        assertEquals("aantal personen met achternaam onjuist", 3, adm.getPersonenMetAchternaam("swinKELs").size());
